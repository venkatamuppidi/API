package atmecs.rest.falcon.runner;
...
import com.atmecs.falcon.automation.rest.util.CustomListener;
...
public class TestNGRunner {
    ...
    public static void uploadTestNGResultsXml() {
        try {
            ...
            String response =
                    testReportUploadClient.upload(dataProvider.getSessionId(), "REST API TEST RESULT", "Web Services", "QA", "Regression",
